          ...
          <div className="flex items-center gap-3 sm:gap-5">
            <a href="#anmeldelser" className="hidden items-center gap-2 md:flex">
              ...
              <span className="text-xs text-white/70">
                <strong className="text-white">4,8</strong> · 1.247 anmeldelser
              </span>
            </a>

            <a
              href="tel:+4570605040"
              className="hidden items-center gap-2 text-sm font-semibold text-white transition-colors hover:text-brand sm:flex"
            >
