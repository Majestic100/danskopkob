  ...
  return (
    <section className="relative overflow-hidden bg-offwhite">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <div className="reveal">
            <div className="mb-5 flex items-center gap-3">
              <span className="inline-flex items-center gap-2 rounded-full border border-black/5 bg-white py-1.5 pl-1.5 pr-3 shadow-soft">
            ...
            {/* Lead-formular i et rent hvidt premium-kort */}
            <div className="mt-7 max-w-lg rounded-2xl border border-black/5 bg-white p-5 shadow-softlg">
          ...
          <div className="reveal relative" style={{ transitionDelay: "120ms" }}>
            <div className="relative overflow-hidden rounded-3xl shadow-softlg ring-1 ring-black/5">
              <img
        ...
        {/* Logo-marquee: bilmærker vi opkøber */}
        <div
